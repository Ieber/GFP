<?php
	...
	if(isset($_POST['entrar'])) {
		...
		if($busca == true){
			...
			$_SESSION['mensagem'] = "<p class='msgSucesso' id='resMsg'>Usuário válido!</p>";
			header('Location: inicio.php');
		} else
			$_SESSION['mensagem'] = "<p class='msgErro' id='resMsg'>Username ou Senha inválida!</p>";
	}
?>
...
<html lang="pt-br">
    ...
    <body class="corpo">
		...
		<form class='login' method='POST' autocomplete='off'>
		    ...
		    <br><br>
		    <input type="submit" name="entrar" id="btnLogin" value="Entrar no GFP">
		</form>
    </body>
</html>
