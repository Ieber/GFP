<?php
    ...
    if(isset($_SESSION['nomeUsuario']) == false) {
        $_SESSION['mensagem'] = "<p name='msg' class='msgErro'>Necessário fazer o login!</p>";
    ...
    if(isset($_POST["atualizar"])) {
        ...
        if($atualiza->rowCount() > 0)
            $_SESSION['mensagem'] = "<p name='msg' class='msgSucesso'>Usuário cadastrado com sucesso!</p>";
        else
            $_SESSION['mensagem'] = "<p name='msg' class='msgSucesso'>Dados de usuário iguais aos já cadastrados!</p>";
