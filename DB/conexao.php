...
Class Consulta {
	...
	public function cadastrarStatusGarrafa($temp_amb1, $temp_amb2, $temp_foco, $humidade) {
        try {
            $insert = $this->pdo->query("INSERT INTO status_garrafa (temp_amb1, temp_amb2, temp_foco, humidade)
                VALUES('$temp_amb1', '$temp_amb2', '$temp_foco', '$humidade')");
        } catch(PDOException $e) {
            echo 'DB Erro: '.$e->getMessage();
        }
        return $insert;
